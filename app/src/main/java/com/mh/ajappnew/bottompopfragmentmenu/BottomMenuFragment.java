package com.mh.ajappnew.bottompopfragmentmenu;
...
public class BottomMenuFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView tv_cancel = (TextView) view.findViewById(R.id.tv_botton_cancel);
        ...
        ListView lv_menu = (ListView) view.findViewById(R.id.lv_botton_menu);
