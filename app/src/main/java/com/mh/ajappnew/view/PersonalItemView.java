...
public class PersonalItemView extends RelativeLayout {
    ...
    public PersonalItemView(final Context context, AttributeSet attrs){
        ...
        ImageView icon = findViewById(R.id.item_personal_icon);
        ImageView more = findViewById(R.id.item_personal_more);
        ImageView line = findViewById(R.id.item_personal_line);
        TextView name = findViewById(R.id.item_personal_name);
        data = findViewById(R.id.item_personal_data);
